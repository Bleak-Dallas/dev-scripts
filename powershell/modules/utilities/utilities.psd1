@{
    ...
    Description       = 'Utility functions (elevation, logging helpers, etc.) for internal scripts.'
    ...
    PrivateData       = @{
        PSData = @{
            Tags         = @('utilities', 'elevation', 'admin')
            ProjectUri   = ''
            LicenseUri   = ''
            IconUri      = ''
            ReleaseNotes = 'Initial release with Invoke-Elevation.'
        }
    }
